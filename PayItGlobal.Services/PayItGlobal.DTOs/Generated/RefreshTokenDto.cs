...
namespace PayItGlobal.DTOs.Generated
{
    ...
    public partial class RefreshTokenDto
    {
        ...
        public RefreshTokenDto(int id, string userId, string token, System.DateTime expires, System.DateTime created, string createdByIp, System.DateTime? revoked, string revokedByIp, string replacedByToken, string reasonRevoked, AspNetUserDto aspNetUser) {

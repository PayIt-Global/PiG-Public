...
{
    public class ApplicationDbContext : IdentityDbContext<AspNetUser, AspNetRole, string, AspNetUserClaim, IdentityUserRole<string>, AspNetUserLogin, AspNetRoleClaim, AspNetUserToken>
    {

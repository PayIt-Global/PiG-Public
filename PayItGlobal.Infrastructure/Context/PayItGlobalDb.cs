...
namespace PayItGlobalApi.Infrastructure.Context
{
    ...
    public partial class PayItGlobalDb : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UsePostgreSql(@"User Id=postgres;Password=password;Host=10.0.0.93;Database=pay_it_global;Persist Security Info=True;Initial Schema=core_identity");
            }
        ...
        private void RefreshTokenMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RefreshToken>().Property(x => x.UserId).HasColumnName(@"user_id").HasColumnType(@"int4").IsRequired().ValueGeneratedNever();
            ...
            modelBuilder.Entity<RefreshToken>().Property(x => x.Iv).HasColumnName(@"iv").HasColumnType(@"text").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<RefreshToken>().Property(x => x.TokenHash).HasColumnName(@"token_hash").HasColumnType(@"text").IsRequired().ValueGeneratedNever();
        ...
        private void RelationshipsMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUser>().HasMany(x => x.RefreshTokens).WithOne(op => op.AspNetUser).HasForeignKey(@"UserId").IsRequired(true);
            ...
            modelBuilder.Entity<RefreshToken>().HasOne(x => x.AspNetUser).WithMany(op => op.RefreshTokens).HasForeignKey(@"UserId").IsRequired(true);
        }

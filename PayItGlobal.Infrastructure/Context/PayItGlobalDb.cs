...
namespace PayItGlobal.Infrastructure.Context
{
    ...
    public partial class PayItGlobalDb : DbContext
    {
        ...
        private void AspNetUserMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUser>().Property(x => x.Id).HasColumnName(@"id").HasColumnType(@"uuid").IsRequired().ValueGeneratedOnAdd().HasDefaultValueSql(@"gen_random_uuid()");
        ...
        private void AspNetUserClaimMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUserClaim>().Property(x => x.UserId).HasColumnName(@"user_id").HasColumnType(@"uuid").ValueGeneratedNever();
        ...
        private void AspNetUserLoginMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUserLogin>().Property(x => x.UserId).HasColumnName(@"user_id").HasColumnType(@"uuid").ValueGeneratedNever();
        ...
        private void AspNetUserTokenMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUserToken>().Property(x => x.UserId).HasColumnName(@"user_id").HasColumnType(@"uuid").IsRequired().ValueGeneratedNever();
